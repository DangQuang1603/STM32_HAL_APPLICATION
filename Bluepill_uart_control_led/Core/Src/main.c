...
int main(void)
{
  ...
  MX_USART1_UART_Init();
  /* USER CODE BEGIN 2 */
  msg = "--------------------UART Control Led--------------------\r\n";
  print_msg(msg);
  msg = "This application will control the LED from this terminal\r\n";
  print_msg(msg);
  msg = "Command control the LED\r\n";
  print_msg(msg);
  msg = "ON: turn on the LED\r\n";
  print_msg(msg);
  msg = "OFF: turn off the LED\r\n";
  print_msg(msg);
